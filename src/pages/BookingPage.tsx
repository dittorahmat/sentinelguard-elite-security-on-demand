...
import { Shield, MapPin, Search, ChevronRight, UserCheck, Zap, Loader2 } from 'lucide-react';
...
export function BookingPage() {
  ...
  useEffect(() => {
    ...
    if (guardId) {
      api<{ items: GuardProfile[] }>('/api/guards').then(res => {
            ...
            >
              {selectedGuard && (
                <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" className="text-slate-500 hover:text-white" onClick={() => setSelectedGuard(null)}>Change</Button>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed font-medium">
                    Sentinel AI has mapped a tactical route between sectors. Dynamic diversion points established for {formData.destination}.
                  </p>
